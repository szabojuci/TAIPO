...
$stmt = $pdo->prepare("SELECT id FROM {$prefix}projects WHERE name = :name");
...
echo "Successfully seeded Mini-Neptun tasks for project: " . $projectName . "\n";
?>
